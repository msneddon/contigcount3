SERVICE = sneddoncontigcounter
SERVICE_CAPS = SneddonContigCounter
SPEC_FILE = SneddonContigCounter.spec
URL = https://kbase.us/services/sneddoncontigcounter
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
...
build-executable-script:
	...
	echo 'python $$script_dir/../$(LIB_DIR)/$(SERVICE_CAPS)/$(SERVICE_CAPS)Server.py $$1 $$2 $$3' >> $(LBIN_DIR)/$(EXECUTABLE_SCRIPT_NAME)
