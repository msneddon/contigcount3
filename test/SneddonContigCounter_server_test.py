...
class SneddonContigCounterTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        for nameval in config.items('SneddonContigCounter'):
            cls.cfg[nameval[0]] = nameval[1]
        cls.wsURL = cls.cfg['workspace-url']
        cls.wsClient = workspaceService(cls.wsURL, token=token)
        cls.serviceImpl = SneddonContigCounter(cls.cfg)
    ...
    def getWsName(self):
        ...
        wsName = "test_SneddonContigCounter_" + str(suffix)
